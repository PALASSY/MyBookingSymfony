...
{
    // Annotation des chemins
    /**
     * Création de 1er Route
     * @Route("/", name ="homepage")
     */
    ...
    {
        $noms = ['PALASSY'=>'admin', 'RAKOTO'=>'visiteur', 'DOE'=>'curieux', 'WEST'=>'testeur'];

        //1er param c'est le fichier twig
        //2em param c'est un tableau pour récupérer les fichiers(JSON,XML,noSql)
        return $this->render('home.html.twig',['titre'=>'Site d\'annonce','access' => 'admin','tableau'=> $noms]);
    }
